<template>
  <v-card class="pa-5">
    ...
    <div class="d-flex">
      <div class="font-weight-bold mr-2">Report Video Test</div>
      (Value Threshold {{ video_threshold.value }} Mbps )
    </div>
    <div class="pmt-flex wrap is-row mt-5">
      <v-col cols="2" xl="2">
        <v-autocomplete
      ...
      <v-col cols="2" xl="2" v-if="selected_status == 1">
        <v-text-field
          type="number"
          dense
          label="Throughput"
