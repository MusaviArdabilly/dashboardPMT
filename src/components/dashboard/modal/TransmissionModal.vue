<template>
  <v-dialog v-model="transmission" width="500" persistent>
    <v-card class="pa-5">
      <v-row>
        <v-col lg="11">
        ...
        <v-col lg="1">
          <v-icon @click="closeTransmission" class="close-ic">mdi-close</v-icon>
        </v-col>
      </v-row>
...
export default {
  ...
  methods: {
    closeTransmission() {
      this.$emit("closeTransmission", false);
    },
    initialize() {
      this.getProvince();
      this.getCity();
