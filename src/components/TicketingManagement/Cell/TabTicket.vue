...
export default {
  ...
  methods: {
    ...
    updateData() {
      ...
      formData.append("province_id", this.selected_data.province_id);
      formData.append("city_id", this.selected_data.city_id);
      formData.append("district_id", this.selected_data.district_id);
      formData.append("sub_district_id", this.selected_data.sub_district_id);
