<template>
  <div class="single-page 0">
    ...
    <div class="page-section">
      <div class="pmt-flex wrap is-row mt-2">
        <v-col cols="3" xl="3">
    ...
    <v-col cols="12" lg="12" xl="12">
      <div class="font-weight-bold mb-5">Channels</div>
    ...
    <div class="pmt-flex is-row wrap">
      <v-col cols="8" lg="8" xl="8">
        <div class="d-flex justify-space-between">
          ...
          <download-excel
            ...
            :fetch="fetchMontelCell"
            :fields="printOutHeader"
            worksheet="My Worksheet"
            name="montel_opsel.xls"
        ...
        <v-card class="pa-5 mb-5 montel-card">
          ...
          <div v-show="!error" v-else v-for="item in results" :key="item.index">
            <div class="d-flex">
              <div>
                <img
      ...
      <v-col cols="4" lg="4" xl="4">
        ...
        <v-card class="pa-5 montel-card">
          ...
          <v-divider style="border-color: #e0e0e0 !important"></v-divider>

          <div class="mt-5 filter-text">Operator</div>
          <v-row>
            <v-col lg="6">
              <v-checkbox
                hide-details
    ...
    <!-- <v-col lg="4">
        <v-card class="montel-card montel-report">
          <div class="pa-2 ml-5 font-weight-bold">
            Montel (Monitoring Telco)
          </div>
          <v-divider></v-divider>
          <div class="d-flex pa-2 align-center">
            <radial-progress-bar
              class="ml-3"
              :diameter="100"
              :completed-steps="completedSteps1"
              :total-steps="totalSteps"
              innerStrokeColor="#ffffff"
              startColor=" #99cafb"
              stopColor=" #99cafb"
            >
              <div>{{ completedSteps1 }}%</div>
            </radial-progress-bar>
            <v-spacer></v-spacer>
            <div class="pr-3">
              <div>Finished 80% ticket from 400, you still have</div>
              <div>800 reported complaint need to process</div>
            </div>
          </div>
        </v-card>
      </v-col> -->
...
<style src="./Montel.css" scoped></style>
