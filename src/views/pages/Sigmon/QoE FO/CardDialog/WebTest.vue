	...
	>
		<v-card>
			<v-card-title class="d-flex justify-center"
				>Web Test (Mbps)</v-card-title
			>
			<v-divider></v-divider>
			<v-card-text class="py-5">
				<v-row v-for="(item, index) in avgWebFo" :key="index">
...
export default {
	...
	methods: {
		closeDialog() {
			this.$parent.dialogWebTest = false;
		},
